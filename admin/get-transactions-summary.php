...
// echo "SSELECT (SUM(totalDueAmount) + SUM(paymentFee) + SUM(penaltyAmount) as total)FROM paid_view WHERE `loggedInUser` =$userId AND billstatus='paid' AND paymentDate='" . date('Y-m-d') . "'";
